...
let testInput = [
  { Name = "pbga"; Weight= 66; Disc = [] }
  { Name = "xhth"; Weight= 57; Disc = [] }
  { Name = "ebii"; Weight= 61; Disc = [] }
  { Name = "havc"; Weight= 66; Disc = [] }
  { Name = "ktlj"; Weight= 57; Disc = [] }
  { Name = "fwft"; Weight= 72; Disc = ["ktlj"; "cntj";"xhth"] }
  { Name = "qoyq"; Weight= 66; Disc = [] }
  { Name = "padx"; Weight= 45; Disc = ["pbga"; "havc";"qoyq"] }
  { Name = "tknk"; Weight= 41; Disc = ["ugml"; "padx";"fwft"] }
  { Name = "jptl"; Weight= 61; Disc = [] }
  { Name = "ugml"; Weight= 68; Disc = ["gyxo" ;"ebii";"jptl"] }
  { Name = "gyxo"; Weight= 61; Disc = [] }
  { Name = "cntj"; Weight= 57; Disc = [] }
]
...
let towers = 
    ...
    |> Array.map (fun x -> x.Split([|'(';')'|],StringSplitOptions.None)|> Array.map (fun (y:string) -> y.Replace("->","").Replace(" ","").Trim()))
    |> Array.map (fun x -> { Name =x.[0]; Weight= int x.[1]; Disc = if x.[2] = "" then [] else x.[2].Split([|','|]) |> List.ofArray } )
    |> List.ofArray
